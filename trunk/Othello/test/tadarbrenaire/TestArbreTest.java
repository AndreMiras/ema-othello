...
public class TestArbreTest {
    ...
    /**
     * Test of maxIndex method, of class TestArbre.
     */
    @Test
    public void testMaxIndex()
    {
        ...
        float result = TestArbre.maxIndex(tabFloat);
    ...
    /**
     * Test of max method, of class TestArbre.
     */
    @Test
    public void testMax()
    {
        ...
        float[] tabFloat = null;
        float expResult = 0.0F;
        float result = TestArbre.max(tabFloat);
        assertEquals(expResult, result, 0.0);
        // TODO review the generated test code and remove the default call to fail.
        fail("The test case is a prototype.");
    }
    ...
    /**
     * Test of min method, of class TestArbre.
     */
    @Test
    public void testMin()
    {
        ...
        float[] tabFloat = null;
        float expResult = 0.0F;
        float result = TestArbre.min(tabFloat);
        assertEquals(expResult, result, 0.0);
        // TODO review the generated test code and remove the default call to fail.
        fail("The test case is a prototype.");
    }
    ...
    /**
     * Test of valmax method, of class TestArbre.
     */
    @Test
    public void testValmax()
    {
        System.out.println("valmax");
        Noeud<MaClasse> noeud = null;
        float expResult = 0.0F;
        float result = TestArbre.valmax(noeud);
        assertEquals(expResult, result, 0.0);
        // TODO review the generated test code and remove the default call to fail.
        fail("The test case is a prototype.");
    }
    ...
    /**
     * Test of valmin method, of class TestArbre.
     */
    @Test
    public void testValmin()
    {
        System.out.println("valmin");
        Noeud<MaClasse> noeud = null;
        float expResult = 0.0F;
        float result = TestArbre.valmin(noeud);
        assertEquals(expResult, result, 0.0);
        // TODO review the generated test code and remove the default call to fail.
        fail("The test case is a prototype.");
    }
